...
Við töluðum um:  
- Lestur í kjörbók
- Knappur texti tilfinningar
- **Lús**lesa 1. kafla í bókinni Neistar

--

Förum yfir heimaverkefnið frá því í þarsíðustu viku
...
- þjálfa okkur í ritun með æfingum sem við hoppuðum yfir í síðasta tíma 
...
**Heimaverkefni**:  
200 orða ***knappur texti*** um einn af fimm þáttum persónuleikans

Það er, úthverfa, taugaveiklun, samviskusemi, samvinnuþýði, víðsýni  

Notaðu glærurnar frá því í fyrra þér til stuðnings og svo kynnir þú fyrir mér verkefnið í næsta tíma

.pull-right[
```{r, fig.align='right'}
xaringanExtra::embed_xaringan("persónuleikaglærur.html", max_width = 450)
```
]
