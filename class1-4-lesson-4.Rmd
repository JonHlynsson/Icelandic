...
## Í dag ætlum við að skoða bókina *Í síma*  

--
```{r, out.width="20%"}
knitr::include_graphics("images/Listin að lesa og skrifa/Í síma/forsíða.png")
```
...
```{r}
knitr::include_app("https://drive.google.com/file/d/1PsGea-elOPqtVbJ8lBgfjIb3D185D3BZ/preview", height = 600)
```
