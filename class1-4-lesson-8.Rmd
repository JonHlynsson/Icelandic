...
.pull-left[
```{r, out.width="50%"}
knitr::include_graphics("images/vikudagar.jpg")
```
...
.pull-right[
<iframe width="560" height="315" src="https://www.youtube.com/embed/fPorKUQdVM4?start=27" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
]
